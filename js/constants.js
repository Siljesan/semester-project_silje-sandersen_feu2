export const corsUrl = "https://noroffcors.herokuapp.com/";
...
export const imgurl = document.querySelector("#imgurl");
export const featured = document.querySelector("#featured");
